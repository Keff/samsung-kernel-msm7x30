...
#ifdef CONFIG_HIGH_MEMORY
#define MSM_PMEM_SF_SIZE	0x1100000 // 17mb
#else
#define MSM_PMEM_SF_SIZE	0x1A00000 // 26mb
#endif
...
#define MSM_PMEM_ADSP_SIZE		0x2800000 // 40mb
#define MSM_FLUID_PMEM_ADSP_SIZE	0x2800000 // 40mb
#define PMEM_KERNEL_EBI0_SIZE		0x600000  // 6mb
